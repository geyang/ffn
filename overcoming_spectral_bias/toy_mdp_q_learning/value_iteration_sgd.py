...
def supervised(f, xs, ys, lr=1e-4, n_epochs=400, batch_size=None):
...
if __name__ == "__main__":
    ...
    **But can the function learn these value functions?** As it turned out, no.
    ...
    plot_value(states, gt_q_values, q_values, losses, fig_prefix="supervised_sgd_2000",
               title="Supervised Value Function (SGD)", doc=doc.table().figure_row())
    ...
    plot_value(states, gt_q_values, q_values, losses, fig_prefix="supervised_rff",
    ...
    plot_value(states, gt_q_values, q_values, losses, fig_prefix=f"dqn_rff_shallow_{10}",
               title=f"DQN RFF (2 layer) $\sigma={10}$", doc=doc.table().figure_row())
    ...
    plot_value(states, gt_q_values, q_values, losses, fig_prefix=f"dqn_rff_no_target_{10}",
               title=f"DQN RFF Shallow", doc=doc.table().figure_row())
