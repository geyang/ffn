...
if __name__ == "__main__":
    ...
    with dumper.Prefix('data'):
        dumper.save_pkl(gt_q_values, "gt_q_values.pkl")  # used later
    ...
    for seed in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
        ...
        with dumper.Prefix('data'):
            dumper.save_pkl(mlp_q_values, f"mlp_q_values_{seed}.pkl", append=False)
            dumper.save_pkl(rff_no_tgt_q_values, f"rff_no_tgt_q_values_{seed}.pkl", append=False)
            dumper.save_pkl(rff_q_values, f"rff_q_values_{seed}.pkl", append=False)
